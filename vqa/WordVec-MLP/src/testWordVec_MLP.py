######################################################################################
#   FileName:       [ testWordVec_MLP.py ]                                           #
#   PackageName:    [ WordVec-MLP ]                                                  #
#   Synopsis:       [ Test WordVec-MLP framework for visual question answering ]     #
...
from utils import  LoadIds, LoadQuestions, LoadAnswers, LoadChoices, LoadVGGFeatures, SavePredictions, LoadGloVe, GetImagesMatrix, GetQuestionsMatrix, GetAnswersMatrix, GetChoicesTensor, MakeBatches, InterruptHandler
...
def main():
    ...
    parser = argparse.ArgumentParser(prog='testWordVec_MLP.py',
